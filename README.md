...
| 15  | A     | Contact form             | The phone number validation does not take Irish numbers starting in 085      | Go to the website> click on the contact form page> enter your details> select phone and attempt to enter digits starting with 085> Observe the issue with the form not validating those      | The form does not validate numbers starting with 085                                                                        | Ensure that the form validates all number | Delete the pattern for Irish numbers after user feedback, as one user reported that could not enter a number starting in 085 and another that would like to enter any other number not only Irish | FIXED  |
